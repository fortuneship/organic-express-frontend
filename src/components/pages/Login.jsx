    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-24 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="#" method="POST">
            <div>
              <label htmlFor="email" className="block text-sm font-medium leading-6 text-[#8f978f]">
                Email address
              </label>
              <div className="mt-2">
                <input
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            ...
            <Link to='/signup' className='className="font-semibold leading-6 text-green-600 hover:text-green-500'>
             Sign up
            </Link>
          </p>
        </div>
